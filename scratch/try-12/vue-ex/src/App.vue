...
const theP = useTemplateRef('the-p')

onMounted(() => {
  console.log(theP.value.innerHTML)
  colorMod3Numbers(theP.value)
})

function colorMod3Numbers(paragraph) {
    ...
    paragraph.innerHTML = coloredHTML;
}
</script>
